...
\begin{frame}[fragile]
    ...
    \hfill\begin{figure}
        \begin{overprint}
        \centering
            \onslide<1> \includegraphics[height=6.3cm]{images/mtacr-2024-april.png} 
            \onslide<2> \includegraphics[height=6.3cm]{images/mtacr-2024-april-targets.png} 
            \onslide<3> \includegraphics[height=6.3cm]{images/mtacr-2024-april-targets.png}  
            \onslide<4> \includegraphics[height=6.3cm]{images/mtacr-2024-april-all.png} 
        \end{overprint}
